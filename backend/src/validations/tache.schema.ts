...
export const createTaskSchema = z.object({
  body: z.object({
    ...
    statut_t: z
      .enum(["todo", "en_cours", "terminee", "TODO", "IN_PROGRESS", "DONE"])
      .optional(),
    priorite_t: z.enum(["LOW", "MEDIUM", "HIGH", "URGENT"]).optional(),
    // Backward-compatible alias accepted during transition.
    priorite: z
      .enum([
        "LOW",
        "MEDIUM",
